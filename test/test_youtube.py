...
def test_downloader_bypass():
    ytd = youtube.downloader(r"https://www.youtube.com/watch?v=_9TgVAYP3XA", bypass=True)
...
def test_downloader():
    ytd = youtube.downloader(r"https://www.youtube.com/watch?v=_9TgVAYP3XA", quality="720", subtitle=["en", "si"])
...
def test_url():
    with pytest.raises(SystemExit):
        ytd = youtube.downloader(r"https://x.com/wonderofscience/status/1997281870434951456")
...
def test_end():
    with patch('rich.prompt.Prompt.ask', return_value='y'), \
         patch('main.handler') as mock_handler:
        project.end()
...
def test_recognizer_url():
    assert utils.recognizer.url("https://www.youtube.com/watch?v=ZVN9LVqAyyo") == "youtube"
